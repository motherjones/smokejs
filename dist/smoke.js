...
module.exports = (function() {
    var $ = require('./libs/jquery-1.9.1.min');
...
},{"./auth":4,"./config":5,"./libs/backbone-min":7,"./libs/dust/dust":8,"./libs/jquery-1.9.1.min":10,"./libs/underscore-min":11}],2:[function(require,module,exports){
/*global module */
'use strict';
...
},{"./libs/backbone-min":7,"./libs/dust/dust":8,"./nameplate":12}],3:[function(require,module,exports){
/*global module */
'use strict';
...
},{"./api_object":1,"./config":5,"./libs/backbone-min":7,"./libs/filereader.min":9,"./libs/jquery-1.9.1.min":10,"./libs/underscore-min":11}],4:[function(require,module,exports){
/*global module */
'use strict';
...
},{"./libs/backbone-min":7}],5:[function(require,module,exports){
/*global define */
'use strict';
...
},{"./libs/backbone-min":7,"./libs/dust/dust":8}],13:[function(require,module,exports){
/*global module */
'use strict';
...
},{"./asset":3,"./content":6,"./libs/backbone-min":7}],14:[function(require,module,exports){
/*global module */
'use strict';
...
},{"./config":5,"./content":6,"./libs/backbone-min":7,"./libs/dust/dust":8}],15:[function(require,module,exports){
/*
 * smoke
...
},{"./application":2,"./libs/backbone-min":7,"./router":13}],16:[function(require,module,exports){
(function(){dust.register("asset_image",body_0);function body_0(chk,ctx){return chk.reference(ctx.get("keyword"),ctx,"h").write("<img class=\"asset\" id=\"slug_").reference(ctx.get("slug"),ctx,"h").write("\" src=\"").reference(ctx.get("media_base"),ctx,"h").reference(ctx.get("data_url"),ctx,"h").write("\"></img>");}return body_0;})();
(function(){dust.register("asset_image.edit",body_0);function body_0(chk,ctx){return chk.write("<form><img class=\"asset preview\" id=\"slug_").reference(ctx.get("slug"),ctx,"h").write("\" src=\"").reference(ctx.get("media_base"),ctx,"h").reference(ctx.get("data_url"),ctx,"h").write("\"></img><label for=\"file_upload_").reference(ctx.get("slug"),ctx,"h").write("\"><input class=\"editable\" type=\"file\" name=\"file_upload_").reference(ctx.get("slug"),ctx,"h").write("\" accept=\"image/*\" /><input type=\"submit\" /></form>");}return body_0;})();
(function(){dust.register("asset_text",body_0);function body_0(chk,ctx){return chk.write("    ").reference(ctx.get("data"),ctx,"h",["s"]);}return body_0;})();
(function(){dust.register("asset_text.edit",body_0);function body_0(chk,ctx){return chk.write("<form><textarea  class=\"editable\" name=\"text_edit_").reference(ctx.get("slug"),ctx,"h").write("\">").reference(ctx.get("data"),ctx,"h",["s"]).write("</textarea><input type=\"submit\" /></form>");}return body_0;})();
(function(){dust.register("full_page",body_0);function body_0(chk,ctx){return chk.write("<div class=\"row full_page_content\" id=\"main_content\">").reference(ctx.get("content"),ctx,"h").write("</div>");}return body_0;})();
(function(){dust.register("main_article",body_0);function body_0(chk,ctx){return chk.write("<p>slug: ").reference(ctx.get("slug"),ctx,"h").write("</p><p> url: ").reference(ctx.get("resource_uri"),ctx,"h").write("</p><p>content type:").reference(ctx.get("spec"),ctx,"h").write("</p>").section(ctx.getPath(false,["attributes","master"]),ctx,{"block":body_1},null).section(ctx.get("members"),ctx,{"block":body_2},null);}function body_1(chk,ctx){return chk.write("<div class=\"master\" id=\"asset_").reference(ctx.get("slug"),ctx,"h").write("\">").reference(ctx.get("load_asset"),ctx,"h").write("</div>");}function body_2(chk,ctx){return chk.write("<div class=\"asset\" id=\"asset_").reference(ctx.get("slug"),ctx,"h").write("\">").reference(ctx.get("load_asset"),ctx,"h").write("</div>");}return body_0;})();
(function(){dust.register("main_article.edit",body_0);function body_0(chk,ctx){return chk.write("<form name=\"article\" id=\"content_").reference(ctx.get("id"),ctx,"h").write("\"><label for=\"slug\">Slug:</label><input class=\"editable\" name=\"slug\" value=\"").reference(ctx.get("slug"),ctx,"h").write("\"></input><formset name=\"metadata\"><label for=\"title\">Title:</label><input class=\"editable\" name=\"metadata.title\" value=\"").reference(ctx.getPath(false,["metadata","title"]),ctx,"h").write("\"></input><label for=\"dek\">Dek:</label><input class=\"editable\" name=\"metadata.dek\" value=\"").reference(ctx.getPath(false,["metadata","dek"]),ctx,"h").write("\"></input></formset><input type=\"submit\"></input></form><form><label for=\"master\">Master Image</label>").section(ctx.getPath(false,["attributes","master"]),ctx,{"block":body_1},null).write("<formfield name=\"members\">").section(ctx.get("members"),ctx,{"block":body_2},null).write("</formfield></form>");}function body_1(chk,ctx){return chk.reference(ctx.get("load_asset"),ctx,"h");}function body_2(chk,ctx){return chk.write("<label>page ").reference(ctx.get("order"),ctx,"h").write(" </label>").reference(ctx.get("load_asset"),ctx,"h");}return body_0;})();
